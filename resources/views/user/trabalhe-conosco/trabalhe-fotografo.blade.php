...
@section('content')
        ...
        <div class="container topo-padding-top topo-padding-bottom">
            ...
            <nav class="mb-4 pb-lg-3 esconderMobile" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Fotógrafo</li>
                </ol>
            </nav>
            ...
            <div class="mb-lg-5 mx-auto text-center paddingAjustesMobile-20" style="max-width: 856px;">
                <h1 class="display-5 mb-4 pb-lg-2">
                    Trabalhe conosco como <span class='text-primary'>Fotógrafo</span>
                </h1>
                <p class="lead opacity-70">
                    Desenvolva sua carreira em fotografia imobiliária conosco. Aqui, seu talento é valorizado e essencial para nosso sucesso.
                </p>
            </div>
    ...
    <section class="container mb-5 pb-lg-5 paddingAjustesMobile-20 paddingTopMobile-40">
        <div class="row align-items-center justify-content-lg-start justify-content-center flex-lg-nowrap gy-4">
            <div class="col-lg-9">
                <img class="rounded-3 tamanhoImagemTrabalhadores" src="assets/img/suaempresa/imagem-fotografo.png" alt="Imagem Fotografo">
            </div>
            <div class="col-lg-4 ms-lg-n5 col-sm-9 text-lg-start text-center">
                <div class="ms-lg-n5 pe-xl-5">
                    ...
                    <p class="mb-4 pb-lg-3 fs-lg">Junte-se à nossa equipe e contribua com suas habilidades criativas para criar imagens e vídeos impactantes.</p>
        ...
        <div class="d-sm-flex justify-content-center">
            <div class="col-md-5 col-lg-4 pt-4 mt-2 pt-md-5 mt-md-3">
                <div class="d-flex pb-4 pb-md-5 mb-2"><i class="fi-file lead text-primary mt-1 order-md-2"></i>
                    ...
                    <p class="fs-sm mb-0">Cadastre-se e permita-nos avaliar seu perfil e portfólio, abrindo portas para novas oportunidades.</p>
                    </div>
                </div>
            ...
            <div class="col-md-5 col-lg-4 pt-md-5 mt-md-3 padding-topTrabalhadores">
                <div class="d-flex pb-4 pb-md-5 mb-2"><i class="fi-info-circle lead text-primary mt-1"></i>
                    ...
                    <p class="fs-sm mb-0">Obtenha demandas diretamente no WhatsApp e e-mail para agendar serviços de maneira flexível com nossos clientes.</p>
                    </div>
                </div>
    ...
    @foreach ($configuracao as $configuracao)
        @if($configuracao->link_fotografos != null)
            <!-- VIDEO -->
            <div class="container margin-bottom-123 max-width-941 paddingAjustesMobile-20">
                <iframe src="{{ $configuracao->link_fotografos }}" class="videoInfosGerais"></iframe>
            </div>
        @endif
    @endforeach
    ...
    <section class="container margin-bottom-123 paddingAjustesMobile-40">
        <div class="row gy-4 align-items-md-center">
          <div class="col-md-6">
            <img src="assets/img/job-board/illustrations/steps.svg" alt="Illustration">
        </div>
          <div class="col-lg-5 offset-lg-1 col-md-6">
            <h2 class="mb-4">Encontrar novos serviços nunca foi tão fácil</h2>
            <p class="mb-4 pb-3 fs-lg">Receba missões via WhatsApp, agende com clientes e carregue o trabalho finalizado no sistema com facilidade.</p>
    ...
    <section class="container mb-5 pb-lg-5 paddingAjustesMobile-40">
        <h2 class="mb-sm-4 pb-md-2 text-center">Faça uma renda extra</h2>
    ...
    <script>
        ...
        (function () {
            ...
            var menuFotografoHeader = document.getElementById('menuFotografo');


            if(menuFotografoHeader != null){
                window.addEventListener('scroll', function () {
                    if (window.scrollY > 0) 
                    {
                        menuFotografoHeader.classList.add('bg-header');
                        menuFotografoHeader.classList.remove('bg-transparente');
                    }
                    else{
                        menuFotografoHeader.classList.remove('bg-header');
                        menuFotografoHeader.classList.add('bg-transparente');
                    } 
                });
            }
