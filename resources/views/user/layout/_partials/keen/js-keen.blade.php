...
<script scr="{{asset('assets/vendor/lightgallery/css/lightgallery-bundle.min.css')}}"></script>
<script scr="{{asset('assets/vendor/lightgallery/plugins/video/lg-video.min.js')}}"></script>
<script scr="{{asset('assets/vendor/tiny-slider/dist/tiny-slider.css')}}"></script>
<script scr="{{asset('assets/vendor/tiny-slider/dist/min/tiny-slider.js')}}"></script>
...
<!--  JAVASCRIPT CONTA USUÁRIO  -->

<!-- Vendor scrits: js libraries and plugins-->
<script src="{{asset('assets/vendor/filepond-plugin-file-validate-type/dist/filepond-plugin-file-validate-type.min.js')}}"></script>

<script src="{{asset('assets/vendor/filepond-plugin-file-validate-size/dist/filepond-plugin-file-validate-size.min.js')}}"></script>

<script src="{{asset('assets/vendor/filepond-plugin-image-preview/dist/filepond-plugin-image-preview.min.js')}}"></script>
<script src="{{asset('assets/vendor/filepond-plugin-image-crop/dist/filepond-plugin-image-crop.min.js')}}"></script>
<script src="{{asset('assets/vendor/filepond-plugin-image-resize/dist/filepond-plugin-image-resize.min.js')}}"></script>
<script src="{{asset('assets/vendor/filepond-plugin-image-transform/dist/filepond-plugin-image-transform.min.js')}}"></script>


<!--  JAVASCRIPT MAPA  -->
{{-- <script src="{{asset('assets/vendor/leaflet/dist/leaflet.css')}}"></script>
<script src="{{asset('assets/vendor/leaflet/dist/leaflet.js')}}"></script> --}}
