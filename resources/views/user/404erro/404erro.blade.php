    ...
    <section class="d-flex align-items-lg-center align-items-end position-relative min-vh-100 py-lg-5 py-0">
        ...
        <div class="row align-items-md-center gy-4">
            ...
            <div class="position-relative zindex-5">
                <h1 class="display-3 text-light">Página não encontrada.</h1>
                <p class="mb-lg-4 mb-3 pb-lg-3 fs-lg text-light opacity-70">Desculpe, não encontramos a página que você está procurando. Sugerimos que você vá para a página inicial enquanto corrigimos o problema.</p>
                ...
                <div class="pt-3"><a class="btn btn-lg btn-primary w-sm-auto w-100 mb-3 me-sm-4" href="{{route('home5')}}">Página Inicial</a><a class="btn btn-lg btn-outline-light w-sm-auto w-100 mb-3" href="{{route('user.contact.duvidas-frequentes')}}">Ajuda</a></div>
            </div>
            </div>
            <div class="col-lg-6 offset-lg-2 order-lg-2 order-1">
            <div class="ratio ratio-1x1 mx-auto" style="max-width: 636px;">
                <lottie-player src="assets/json/animation-real-estate-404.json" background="transparent" speed="1" loop autoplay></lottie-player>
            </div>
            </div>
        </div>
        </div>
