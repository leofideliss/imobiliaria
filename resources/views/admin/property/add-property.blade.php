...
@section('content')
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-xxl">
            ...
            <div class="card card-flush">
                <!--begin::Card body-->
                <div class="card-body">
                    <div class="stepper " id="stepper_add_property">
                        ...
                        <ul
                            ...
                            <li class="nav-item stepper-item current" data-kt-stepper-element="nav">
                                <span class="nav-link text-active-primary d-flex align-items-center pb-5 active"
                                    data-bs-toggle="tab" href="#kt_properties">
                            ...
                            <li class="nav-item stepper-item " data-kt-stepper-element="nav">
                                <span class="nav-link text-active-primary d-flex align-items-center pb-5"
                                    data-bs-toggle="tab" href="#kt_vendor_info">
                        ...
                        <form id="kt_properties_form" class="form" action=""
                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane flex-column current" data-kt-stepper-element="content"
                                    ...
                                    <!--begin::TITULO DO IMÓVEL-->
                                    {{-- <div class="row fv-row mb-7">
                                                        <div class="col-md-3 text-md-end">
                                                            <!--begin::Label-->
                                                            <label class="fs-6 fw-semibold form-label mt-3">
                                                                <span class="required">Título do Imóvel</span>
                                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                                    title="Digite o título do anúncio do imóvel.">
                                    ...
                                    <div class="row fv-row mb-7" id="hiddenDiv3" style="display:none">
                                        <div class="col-md-3 text-md-end">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3">
                                                <span class="required">Selecione um condomínio</span>
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                    title="Selecione um condomínio para vincular ao imóvel.">
                                                    <i class="fa-solid fa-circle-exclamation text-gray-500 fs-6"></i>
                                                </span>
                                            </label>
                                            <!--end::Label-->
                                        ...
                                        <div class="align-self-center col-md-4 text-muted">
                                            <span id="condominio_selected" data-cond-id=""></span>
                                            <i class="fa-solid fa-xmark text-danger d-none" id="removeCondominioSelected" style="cursor: pointer;"></i>
                                        </div>
                                ...
                                <div class="tab-pane flex-column" data-kt-stepper-element="content"
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select class="form-select form-select-solid"
                                                data-placeholder="Tipo do Imóvel" name="type_prop_id"
                                                onchange="pegarTextoSelect()" id="type_prop_id">
                                            </select>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <select class="form-select form-select-solid" onchange="myFinalidade()"
                                                data-placeholder="categoria" name="finalidadeUtilizacao"
                                                id="finalidadeUtilizacao">
                                    ...
                                    <div class="row fv-row mb-7" id="hiddenPrecoVenda">
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid " id=""
                                                placeholder="R$" name="prop_price" onKeyUp="mascaraMoeda(this, event)">
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::PREÇO DO IMÓVEL -->
                                    ...
                                    <div class="row fv-row mb-7" id="hiddenPrecoAlug" style="display:none">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control form-control-solid " placeholder="R$"
                                                name="prop_rent" onKeyUp="mascaraMoeda(this, event)">
                                        </div>
                                    ...
                                    <div class="row fv-row mb-7">
                                        <div class="col-md-3 text-md-end">
                                            ...
                                            <label class="fs-6 fw-semibold form-label mt-3">
                                                ...
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                                    title="Digite o valor do IPTU do último ano.">
                                                    <i class="fa-solid fa-circle-exclamation text-gray-500 fs-6"></i>
                                                </span>
                                            </label>
                                            <!--end::Label-->
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid " id=""
                                                name="iptu_price" onKeyUp="mascaraMoeda(this, event)" placeholder="R$">
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::IPTU -->
                                    ...
                                    <div class="row fv-row mb-7">
                                        <div class="col-md-3 text-md-end">
                                            <!--begin::Label-->
                                            <label class="fs-6 fw-semibold form-label mt-3">
                                                <span class="required">Comissão</span>
                                                <span class="ms-1" data-bs-toggle="tooltip"
                                ...
                                <div class="tab-pane flex-column" data-kt-stepper-element="content"
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="text" class="form-control form-control-solid kt_inputmask_cep"
                                                name="CEP" value="" onblur="pesquisacep(this.value);" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::CEP -->
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <!--begin::Input-->
                                            <input type="text" class="form-control form-control-solid"
                                                name="complement" id="complement" value="" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::COMPLEMENTO -->
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            <textarea class="form-control form-control-solid" rows="3" id="description_html" name="description"
                                                placeholder="Descrição" style="height: 184px;"></textarea>
                                        </div>
                                    </div>
                                    <!--end::DESCRIÇÃO -->
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="dropzone" id="divDropzone">
                                                <div class="dz-message needsclick">
                                                    ...
                                                    <!--begin::Info-->
                                                    <div class="ms-4">
                                                        <h3 class="fs-5 fw-bold text-gray-900 mb-1">Solte as imagens aqui
                                                            ou
                                                            clique para carregar</h3>
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="text"
                                                ...
                                                name="phone_vendor" value=""  readonly="true"/>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::TELEFONE -->
                                    ...
                                    <div class="row fv-row mb-7">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <input type="text"
                                                ...
                                                name="email_vendor" value="" readonly="true"/>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <!--end::Email -->
    ...
    <script>
        ...
        // var botaoModalCondominio = document.getElementById('botaoModalCondominio');
        var proprietarios

        // var add_condominio = document.getElementById('add_condominio');

        $('#botaoModalCondominio').click(function(event) {
            event.preventDefault(); // Evita qualquer ação padrão do botão (não afeta o modal)
