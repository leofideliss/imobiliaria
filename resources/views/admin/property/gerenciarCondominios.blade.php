    <!--begin::Modal - -->
    <div class="modal fade" id="add_condominio" tabindex="-1" aria-hidden="true">
        <!--begin::Modal dialog-->
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-15 pb-15">
                    ...
                    <form id="kt_modal_new_ticket_form" class="form" action="#">
                        ...
                        <div class="mb-5 text-center ">
                            <!--TITULO-->
                            <h1>Selecione o condomínio do imóvel</h1>
                        </div>
                        <!--end::Heading-->
                                ...
                                <div class="dataTables_scroll">
                                    ...
                                    <div class="dataTables_scrollBody"
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                            id="kt_table_select_condominio" style="width: 100%;">
                                            <tbody class="fw-semibold text-gray-600">
                                                {{-- <tr class="odd">
                                                    <td>
                                                        <label class="form-check form-check-sm form-check-custom form-check-solid">
                                                            <input class="form-check-input" type="radio" name="checkboxComentarioPost">
                                                        </label>
                                                    </td>
                                                    <td>
                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
                                                            ...
                                                            <div class="ms-5">
                                                                <!--begin::Titulo-->
                                                                <div class="text-gray-800 text-hover-primary fs-5 fw-bold">Nome do Condomínio</div>
                                                                <!--begin::Titulo-->
                                                ...
                                                <div class="d-flex justify-content-center" style="margin: 10px;">
                                                    ...
                                                    <div class="spinner-grow text-warning" role="status"  id="loading_condominio" >
