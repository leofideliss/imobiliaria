                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            {{-- <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                <a href="#"
                                    class="btn btn-light fw-bold fs-8 fs-lg-base" data-action="import_xml">Importar imóveis</a>
                                <a href="#"
                                    class="btn btn-light fw-bold fs-8 fs-lg-base" data-action="export_xml">Exportar imóveis</a>
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Table-->
                            <div id="kt_properties_list_customer_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div class="table-responsive">
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                        id="kt_properties_list_customer_table">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                <th class="min-w-100px w-120px sorting" tabindex="0"
                                                    aria-controls="kt_properties_list_customer_table" rowspan="1" colspan="1"
