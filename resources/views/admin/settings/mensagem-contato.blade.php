                ...
                <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-body pt-0">
                            <!--begin::Table-->
                            <div id="kt_mensagem_contato_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                <div class="table-responsive">
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                                        id="kt_mensagem_contato">
                                        <thead>
                                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                <th class="min-w-100px w-120px sorting" tabindex="0"
                                                    aria-controls="kt_mensagem_contato" rowspan="1" colspan="1"
                                                    aria-label="Product: activate to sort column ascending"
                                                    style="width: 300.938px;">Nome</th>
                                                <th class="min-w-100px w-120px sorting" tabindex="0"
                                                aria-controls="kt_mensagem_contato" rowspan="1" colspan="1"
                                                aria-label="Product: activate to sort column ascending"
                                                style="width: 300.938px;">Código do Imóvel</th>
