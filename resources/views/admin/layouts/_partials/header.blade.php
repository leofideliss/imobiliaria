...
<div class="d-flex align-items-center justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
    ...
    <div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
        ...
        <!--begin::Menu-->
        {{-- Remover d-none --}}
        <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0 d-none"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 mb-6 mb-lg-0">
                                        ...
                                        <div class="mb-0">
                                            ...
                                            <div class="menu-item p-0 m-0">
                                                <!--begin:Menu link-->
                                                <a href="../../demo1/dist/authentication/general/maintenance.html"
                                                    class="menu-link">
                    ...
                    <div class="menu-state-bg pt-1 pb-3 px-3 py-lg-6 px-lg-6" data-kt-menu-dismiss="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 mb-3 pt-2 pe-lg-8">
                                <img src="{{ asset('assets/media/stock/900x600/74.jpg') }}" class="rounded mw-100"
                                    alt="" />
                            </div>
                            <!--end:Col-->
                        </div>
                        ...
                        <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-lg-5">
                            ...
                            <a href="https://preview.keenthemes.com/keen/layout-builder.html"
            ...
            <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start"
                ...
                <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                    ...
                    <div class="menu-item">
                        <!--begin:Menu link-->
                        <a class="menu-link" href="https://preview.keenthemes.com/html/keen/docs" target="blank"
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link"
                            ...
                            <span class="menu-title">Changelog v3.0.1</span>
                        </a>
                        <!--end:Menu link-->
                    </div>
                    <!--end:Menu item-->
