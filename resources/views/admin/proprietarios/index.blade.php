                    ...
                    <div class="card card-flush">
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            ...
                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                ...
                                <button class="btn btn-primary fw-bold fs-8 fs-lg-base" data-toggle="modal"
                                    id="openModalProprietario" data-target="#kt_modal_new_proprietario">Adicionar
                                    Proprietario</button>
                            </div>
                            <!--end::Card toolbar-->
                        </div>
