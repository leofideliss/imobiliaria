    ...
    <div class="d-flex flex-column flex-column-fluid">
        ...
        <div id="kt_app_content" class="app-content flex-column-fluid">
            ...
            <div id="kt_app_content_container" class="app-container container-xxl">
                    ...
                    <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-ecommerce-product-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Buscar Corretor">
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--end::Card title-->
                        ...
                        <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_new_user" class="btn btn-primary fw-bold fs-8 fs-lg-base">Adicionar Corretor</a>
               ...
               @include("admin.user.corretor.add-corretor")
