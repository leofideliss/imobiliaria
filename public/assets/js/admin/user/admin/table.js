...
var KTAdminList = function () {
    ...
    var initDatatable = function () {
        ...
        datatable = $('#kt_admin_table').DataTable({
            'searchDelay': 500,
            'processing': true,
            'serverSide': true,
            'pageLength': 10,
            'order': [[0, 'asc']],
            'ajax': { url: `${urlBase}/user/listUserJson`, dataSrc: "data" },
            'columns': [
                { data: 'name' },
                { data: 'email' },
                { data: 'status' },
                ...
                },
                {
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                        ...
                        <div class="menu-item px-3">
                            <a href="${urlBase}/user/getAdmin/${data}" data-toggle="modal" data-target="#kt_modal_new_admin" data-user-id="${data}"
                        ...
                        <div class="menu-item px-3">
                                ...
                                href="${urlBase}/user/deleteAdmin/${data}"
    ...
    var editUserAdmin = function () {
        let buttonEdit = $('[data-target="#kt_modal_new_admin"]')
        buttonEdit.each(function (i, element) {
            element.addEventListener("click", function (e) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function (e) {
                        $("input[name=name]").val(e.user.name)
                        $("input[name=CPF]").val(e.user.CPF)
                        $("input[name=email]").val(e.user.email)
                        $("input[name=phone]").val(e.user.phone)
    ...
    return {
        // Public functions  
        init: function () {
            table = document.querySelector('#kt_admin_table');
            if (!table) {
                return
            }
