...
var KTPropertiesListAdmin = function () {
    ...
    var initDatatable = function () {
        ...
        datatable = $('#kt_properties_list_table_admin').DataTable({
            'searchDelay': 500,
            'processing': true,
            'serverSide': true,
            'pageLength': 10,
            // 'order': [[0, 'asc']],
            'ajax': { url: `${urlBase}/property/listPropertiesJsonAdmin`, dataSrc: "data" },
            'columns': [
                { data: 'photo' },
   ...
   <Listings>`
    ...
    return {
        ...
        init: function () {
            ...
            table = document.querySelector('#kt_properties_list_table_admin');
            if (!table) {
                return
            }
